...
1. On the **Kubernetes services** blade, click **+ Create** and, in the drop-down menu, click **+ Create a Kubernetes cluster**
...
1. Open a new browser tab and browse to the IP address you identified in the previous step.
